...
class BirdEyeHyperNode(Node):
    ...
    def main_loop(self):
        while rclpy.ok():
            ...
            left_x, right_x, scan_y = self.process_lane_pixels(mask)
            ...
            self.curr_steering_angle = target_angle
